...
var serverUrl = "http://evaluation.floprey.at/saveData4.php";
...
evalApp.controller('questionsCtrl', function($scope, $http, $routeParams, $location, $anchorScroll) {
    ...
    $scope.checkNoAnswer = function (value, questionId) {
        if (value == "Ich habe keine Ahnung") {
            angular.forEach($scope.useranswers[questionId].answer, function (answer, index) {
                if(answer != "Ich habe keine Ahnung") {
                    delete $scope.useranswers[questionId].answer[index];
                }
            });
        } else {
            angular.forEach($scope.useranswers[questionId].answer, function (answer, index) {
        ...
        console.log($scope.useranswers[questionId].answer);
    };
