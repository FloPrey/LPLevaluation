...
var serverUrl = "http://evaluation.floprey.at/saveData2b.php";
...
evalApp.controller('task4Ctrl', function ($scope, $location) {
    ...
    lpl.create("lplTemplate", {lplLoad: "ajax", lplRaw: "lpltask4.json", lplRes: "lplRes", triggerForm: true, lang: "de"});
    $scope.saveTask = function() {
        $scope.date = new Date();
        $scope.neededTime = (performance.now() - $scope.starttime) / 1000;
